...
public class DataConverterTests {
                        ...
                        try {
                            ...
                            try {
                                ...
                                try {
                                    ...
                                    try {
                                        DataConverter.toByte(new Orange());
                                        fail("Convert should fail");
                                    } catch (Exception ex) {
                    ...
                    try {
                        ...
                        try {
                            ...
                            try {
                                ...
                                try {
                                    DataConverter.toShort(new Orange());
                                    fail("Convert should fail");
                                } catch (Exception ex) {
                                    assertTrue(ex instanceof NumberFormatException);
                                }
                ...
                try {
                    ...
                    try {
                        ...
                        try {
                            ...
                            try {
                                DataConverter.toInt( new Orange());
                                fail( "Convert should fail" );
                            } catch( Exception e6 ) {
    ...
    public void testLongFails() {
        ...
        try {
            ...
            try {
                ...
                try {
                    DataConverter.toLong(new Orange());
                    fail("Convert should fail");
                } catch (Exception e6) {
                    assertTrue(e6 instanceof NumberFormatException);
                }
    ...
    public void testFloatFails() {
        ...
        try {
            ...
            try {
                DataConverter.toFloat( new Orange());
                fail( "Convert should fail" );
            } catch( Exception e6 ) {
                assertTrue( e6 instanceof NumberFormatException );
            }
    ...
    public void testDateFails() {
        ...
        try {
            ...
            try {
                ...
                try {
                    DataConverter.toDate(new Orange());
                    fail("Convert should fail");
                } catch (Exception e6) {
                    assertTrue(e6 instanceof NumberFormatException);
                }
