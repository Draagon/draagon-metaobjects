...
public class EnhancementsIntegrationTest {
    ...
    private static class TestObjectManager extends ObjectManager {
        ...
        @Override
        public boolean isCreateableClass(com.metaobjects.object.MetaObject mc) { return true; }
        @Override
        public boolean isReadableClass(com.metaobjects.object.MetaObject mc) { return true; }
        @Override
        public boolean isUpdateableClass(com.metaobjects.object.MetaObject mc) { return true; }
        @Override
        public boolean isDeleteableClass(com.metaobjects.object.MetaObject mc) { return true; }
        ...
        @Override
        public java.util.Collection<?> getObjects(ObjectConnection c, com.metaobjects.object.MetaObject mc, QueryOptions options) throws MetaDataException {
