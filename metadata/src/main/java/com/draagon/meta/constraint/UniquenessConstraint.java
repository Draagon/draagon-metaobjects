...
public class UniquenessConstraint extends BaseConstraint {
        ...
        return new UniquenessConstraint(
            ...
            (metaData) -> {
                if (metaData instanceof com.draagon.meta.object.MetaObject) {
                    ...
                    return obj.getChildren(com.draagon.meta.field.MetaField.class).stream()
    ...
    public static UniquenessConstraint forKeyNames(String constraintId, String description,
        ...
        return new UniquenessConstraint(
            ...
            (metaData) -> {
                if (metaData instanceof com.draagon.meta.object.MetaObject) {
                    com.draagon.meta.object.MetaObject obj = (com.draagon.meta.object.MetaObject) metaData;
                    return obj.getChildren(com.draagon.meta.key.MetaKey.class).stream()
                        .map(key -> key.getName())
                        .collect(Collectors.toList());
                }
                return List.of();
    ...
    public static UniquenessConstraint forAttributeNames(String constraintId, String description,
        ...
        return new UniquenessConstraint(
            ...
            targetType, targetSubType, "*",
            (metaData) -> {
                return metaData.getChildren(com.draagon.meta.attr.MetaAttribute.class).stream()
