...
/**
 * Simple length validation constraint that's easy to serialize to schemas.
 *
 * Example usage:
 * - Min length: new SimpleLengthConstraint("field.name.min", "Field names must be at least 2 chars",
 *                                         "field", "*", "*", 2, null)
 * - Max length: new SimpleLengthConstraint("attr.description.max", "Descriptions max 255 chars",
 *                                         "attr", "string", "description", null, 255)
 * - Range: new SimpleLengthConstraint("field.name.range", "Field names 2-64 characters",
 *                                    "field", "*", "*", 2, 64)
 */
public class SimpleLengthConstraint extends SimpleConstraint {
     ...
     */
    public SimpleLengthConstraint(String constraintId, String description,
