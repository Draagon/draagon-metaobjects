...
/**
 * Simple enumeration validation constraint that's easy to serialize to schemas.
 *
 * Example usage:
 * - Field types: new SimpleEnumConstraint("field.type.enum", "Valid field types",
 *                                        "field", "*", "type",
 *                                        Set.of("string", "int", "long", "double", "boolean"))
 * - Status values: new SimpleEnumConstraint("object.status.enum", "Valid status values",
 *                                          "object", "*", "status",
 *                                          Set.of("active", "inactive", "deleted"))
 */
public class SimpleEnumConstraint extends SimpleConstraint {
     ...
     */
    public SimpleEnumConstraint(String constraintId, String description,
