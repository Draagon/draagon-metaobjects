...
public class TypeDefinitionBuilder {
    ...
    /**
     * Start defining an optional attribute with fluent constraint specification
     *
     * @param attrName Attribute name (should use constants like ATTR_FIELDS, ATTR_GENERATION)
     * @return AttributeConstraintBuilder for fluent constraint specification
     */
    public AttributeConstraintBuilder optionalAttributeWithConstraints(String attrName) {
        return new AttributeConstraintBuilder(this, attrName, false);
    }

    /**
     * Start defining a required attribute with fluent constraint specification
     *
     * @param attrName Attribute name (should use constants like ATTR_FIELDS, ATTR_GENERATION)
     * @return AttributeConstraintBuilder for fluent constraint specification
     */
    public AttributeConstraintBuilder requiredAttributeWithConstraints(String attrName) {
        return new AttributeConstraintBuilder(this, attrName, true);
    }

    /**
     * Add an auto-generated constraint from fluent builders
     *
     * @param constraint Constraint to add to the auto-generated list
     */
    public void addAutoGeneratedConstraint(Constraint constraint) {
        autoGeneratedConstraints.add(constraint);
    }
