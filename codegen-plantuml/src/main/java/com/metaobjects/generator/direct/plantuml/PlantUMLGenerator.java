...
import com.metaobjects.generator.direct.SingleFileDirectGeneratorBase;
...
import static com.metaobjects.generator.util.GeneratorUtil.getFilteredMetaData;
    ...
    public static class Builder {
        ...
        public PlantUMLGenerator build() {
            ...
            if (outputFilename != null) {
                args.put(com.metaobjects.generator.GeneratorBase.ARG_OUTPUTFILENAME, outputFilename);
            }
            if (outputDir != null) {
                args.put(com.metaobjects.generator.GeneratorBase.ARG_OUTPUTDIR, outputDir);
            }
