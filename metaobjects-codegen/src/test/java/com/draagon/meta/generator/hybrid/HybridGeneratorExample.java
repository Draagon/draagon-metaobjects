...
public class HybridGeneratorExample {
     ...
     */
    @Test
    public void demonstrateEnhancedDirectGeneration() {
     ...
     */
    @Test 
    public void demonstrateHybridGenerationWithCustomFragments() {
     ...
     */
    @Test
    public void demonstrateFullHybridGeneration() {
    ...
    private MetaDataLoader createSampleLoader() {
        ...
        try {
            ...
            // return new SimpleLoader("test-loader").setSourceURIs(...).init();
            
            // For now, return a placeholder that would work if metadata files existed
            SimpleLoader loader = new SimpleLoader("test-file-loader");
            // loader.setSourceURIs(...).init();
            return loader;
